                ...
                <li class="has-sub active expand">
                    ...
                    <ul class="collapse show" id="dashboard" data-parent="#sidebar-menu">
                        <div class="sub-menu">
                            ...
                            <li class="active">
                                <a class="sidenav-item-link" href="{{ route('reconnections.index') }}">
                                    <span class="nav-text">Re-Connection</span>
                                </a>
                            </li>
                            <li class="active">
                                <a class="sidenav-item-link" href="{{ route('new-connections.index') }}">
                                    <span class="nav-text">New Connection</span>
                                </a>
                            </li>
                            <li class="active">
                                <a class="sidenav-item-link" href="{{ route('package.index') }}">
                                    <span class="nav-text">Internet Package</span>
                                </a>
                            </li>
                            <li class="active">
                    ...
                    <a class="sidenav-item-link" href="javascript:void(0)" data-toggle="collapse"
                        ...
                        <span class="nav-text">Connection</span> <b class="caret"></b>
                    </a>
                    <ul class="collapse show" id="dashboard" data-parent="#sidebar-menu">
                        <div class="sub-menu">
                ...
                <li class="has-sub">
                    ...
                    <ul class="collapse" id="ui-elements" data-parent="#sidebar-menu">
                        <div class="sub-menu">
                            ...
                            <li class="active">
                                <a class="sidenav-item-link" href="{{url('admin/directors')}}">
                                    <span class="nav-text">Board of Directors</span>

                                </a>
                            </li>

                            <li class="active">
                                <a class="sidenav-item-link" href="{{url('admin/management')}}">
                                    <span class="nav-text">Our Management</span>

                                </a>
                            </li>

                            <li class="active">
                                <a class="sidenav-item-link" href="{{url('admin/team')}}">
